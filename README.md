...
module "vpn" {
  ...
  source              = "git::https://github.com/sohanyadav/terraform-azure-vpn.git?ref=v1.0.1"
  name                = local.name
...
# Examples
For detailed examples on how to use this module, please refer to the [examples](https://github.com/sohanyadav/terraform-azure-vpn/blob/master/example) directory within this repository.

# License
This Terraform module is provided under the **MIT** License. Please see the [LICENSE](https://github.com/sohanyadav/terraform-azure-vpn/blob/master/LICENSE) file for more details.
